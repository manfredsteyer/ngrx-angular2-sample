System.register(['angular2/core', './boarding.service', '@ngrx/store', './boarding.reducer', './buchungs-status.pipe', './buchungs-status-farbe.pipe'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, boarding_service_1, store_1, boarding_reducer_1, buchungs_status_pipe_1, buchungs_status_farbe_pipe_1;
    ...
    return {
        setters:[
            ...
            function (buchungs_status_farbe_pipe_1_1) {
                buchungs_status_farbe_pipe_1 = buchungs_status_farbe_pipe_1_1;
            }],
        execute: function() {
            BoardingComponent = (function () {
                ...
                BoardingComponent.prototype.ngOnInit = function () {
                    ...
                    this.statistik = this.store.select(function (s) { return s.boarding.statistik; });
                };
                Object.defineProperty(BoardingComponent.prototype, "buchungen", {
                    get: function () {
                        return this.store.select(function (s) { return s.boarding.buchungen; });
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(BoardingComponent.prototype, "countBoarded", {
                    get: function () {
                        return this.statistik.map(function (s) { return s.countBoarded; });
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(BoardingComponent.prototype, "countBooked", {
                    get: function () {
                        return this.statistik.map(function (s) { return s.countBooked; });
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(BoardingComponent.prototype, "countCheckedIn", {
                    get: function () {
                        return this.statistik.map(function (s) { return s.countCheckedIn; });
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                BoardingComponent.prototype.changeState = function (buchung, state) {
                    ...
                    this.store.dispatch({ type: boarding_reducer_1.BUCHUNG_STATE_CHANGED, payload: newBuchung });
                };
                BoardingComponent.prototype.undo = function () {
                    this.store.dispatch({ type: boarding_reducer_1.BUCHUNG_UNDO });
                };
                BoardingComponent.prototype.redo = function () {
                    this.store.dispatch({ type: boarding_reducer_1.BUCHUNG_REDO });
                };
                BoardingComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/boarding/boarding.component.html',
                        providers: [boarding_service_1.BoardingService],
                        pipes: [buchungs_status_pipe_1.BuchungsStatusPipe, buchungs_status_farbe_pipe_1.BuchungsStatusFarbePipe],
