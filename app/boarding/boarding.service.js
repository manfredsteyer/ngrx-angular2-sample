System.register(['angular2/http', 'angular2/core', '@ngrx/store', './boarding.reducer'], function(exports_1, context_1) {
    "use strict";
    ...
    var http_1, core_1, store_1, boarding_reducer_1;
    var BoardingService;
    return {
        setters:[
            function (http_1_1) {
            ...
            BoardingService = (function () {
                ...
                BoardingService.prototype.find = function (flugId) {
                    ...
                    this.http
                        ...
                        that.store.dispatch({ type: boarding_reducer_1.BUCHUNGEN_LOADED, payload: buchungen });
                    }, function (err) {
                        console.debug(err);
                    });
                };
